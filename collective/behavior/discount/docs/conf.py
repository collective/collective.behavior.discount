...
project = u'collective.behavior.discount'
...
htmlhelp_basename = 'collective.behavior.discountdoc'
...
latex_documents = [
  ('index', 'collective.behavior.discount.tex', u'collective.behavior.discount Documentation',
...
man_pages = [
    (
        'index',
        'todo',
        u'collective.behavior.discount Documentation',
        [u'Taito Horiuchi'],
        1)]
